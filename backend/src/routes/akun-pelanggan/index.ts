...
import { requireAdmin, hashPassword } from "../../auth/index.js";
            ...
            try {
                ...
                const newAkunPelanggan = await prisma.akunPelanggan.create({
                    data: {
                        ...
                        hashed_password: await hashPassword(dto.hashed_password), // Hashed di sini
            ...
            try {
                ...
                const updatedAkunPelanggan = await prisma.akunPelanggan.update({
                    ...
                    data: {
                        ...
                        ...(dto.hashed_password && { hashed_password: await hashPassword(dto.hashed_password) }), // Hashed di sini
