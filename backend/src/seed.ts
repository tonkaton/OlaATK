...
async function seed() {
  ...
  await prisma.konfigurasi.createMany({
    data: [
      ...
      { kunci: "harga_cetak_a4_bw", nilai: "500", deskripsi: "Harga Cetak A4 B/W", tipe: "number", grup: "harga", urutan: 7 },
      { kunci: "harga_cetak_a4_color", nilai: "1500", deskripsi: "Harga Cetak A4 Warna", tipe: "number", grup: "harga", urutan: 8 },
      { kunci: "harga_cetak_f4_bw", nilai: "600", deskripsi: "Harga Cetak F4 B/W", tipe: "number", grup: "harga", urutan: 9 },
      { kunci: "harga_cetak_f4_color", nilai: "2000", deskripsi: "Harga Cetak F4 Warna", tipe: "number", grup: "harga", urutan: 10 },
      { kunci: "harga_jilid_lakban", nilai: "3000", deskripsi: "Biaya Jilid Lakban", tipe: "number", grup: "harga", urutan: 11 },
      { kunci: "harga_jilid_softcover", nilai: "15000", deskripsi: "Biaya Jilid Softcover", tipe: "number", grup: "harga", urutan: 12 },
      { kunci: "harga_jilid_hardcover", nilai: "35000", deskripsi: "Biaya Jilid Hardcover", tipe: "number", grup: "harga", urutan: 13 },
      { kunci: "harga_jilid_spiral", nilai: "10000", deskripsi: "Biaya Jilid Spiral", tipe: "number", grup: "harga", urutan: 14 },
      { kunci: "harga_fotokopi_a4", nilai: "300", deskripsi: "Harga Fotokopi A4", tipe: "number", grup: "harga", urutan: 15 },
      { kunci: "harga_fotokopi_f4", nilai: "500", deskripsi: "Harga Fotokopi F4", tipe: "number", grup: "harga", urutan: 16 },
      { kunci: "harga_fotokopi_a4_color", nilai: "2000", deskripsi: "Harga Fotokopi A4 Warna", tipe: "number", grup: "harga", urutan: 17 },
      { kunci: "harga_fotokopi_f4_color", nilai: "2500", deskripsi: "Harga Fotokopi F4 Warna", tipe: "number", grup: "harga", urutan: 18 },
      { kunci: "harga_laminating_a4", nilai: "5000", deskripsi: "Harga Laminating A4", tipe: "number", grup: "harga", urutan: 19 },
      { kunci: "harga_laminating_f4", nilai: "6000", deskripsi: "Harga Laminating F4", tipe: "number", grup: "harga", urutan: 20 },
      { kunci: "harga_scan", nilai: "1500", deskripsi: "Harga Scan", tipe: "number", grup: "harga", urutan: 21 },
    ],
  });
